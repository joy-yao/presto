        ...
        extends Statement
{
    ...
    public CreateTableAsSelect(QualifiedName name, Query query, boolean notExists, Map<String, Expression> properties, boolean withData, boolean materializedQueryTable)
    {
        this(Optional.empty(), name, query, notExists, properties, withData, materializedQueryTable);
    }

    public CreateTableAsSelect(NodeLocation location, QualifiedName name, Query query, boolean notExists, Map<String, Expression> properties, boolean withData, boolean materializedQueryTable)
    {
        this(Optional.of(location), name, query, notExists, properties, withData, materializedQueryTable);
    }

    private CreateTableAsSelect(Optional<NodeLocation> location, QualifiedName name, Query query, boolean notExists, Map<String, Expression> properties, boolean withData, boolean materializedQueryTable)
    {
        super(location);
