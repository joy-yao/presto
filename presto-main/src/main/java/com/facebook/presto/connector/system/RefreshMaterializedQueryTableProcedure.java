...
public class RefreshMaterializedQueryTableProcedure
{
    ...
    public Procedure getProcedure()
    {
        return new Procedure(
                ...
                "admin_refresh",
                ImmutableList.of(
                        new Procedure.Argument("materializedQueryTable", VARCHAR),
                        new Procedure.Argument("predicateForBaseTables", VARCHAR),
                        new Procedure.Argument("predicateForMaterializedQueryTable", VARCHAR)),
