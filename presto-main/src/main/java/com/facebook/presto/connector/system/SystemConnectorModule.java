        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        binder.bind(RefreshMaterializedViewProcedure.class).in(Scopes.SINGLETON);
    ...
    @ProvidesIntoSet
    public static Procedure getRefreshMaterializedViewProcedure(RefreshMaterializedViewProcedure procedure)
    {
        return procedure.getProcedure();
    }
