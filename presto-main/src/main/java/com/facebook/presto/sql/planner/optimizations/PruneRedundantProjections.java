            ...
            extends PlanRewriter<Void>
    {
        ...
        public PlanNode visitProject(ProjectNode node, RewriteContext<Void> context)
        {
            ...
            for (Map.Entry<Symbol, Expression> entry : node.getAssignments().entrySet()) {
                ...
                if (!(expression instanceof DeReferenceExpression) || ((DeReferenceExpression) expression).getBase().isPresent() || !((DeReferenceExpression) expression).getFieldName().equals(symbol.getName())
...
//                        && ((DeReferenceExpression) expression).getFieldName().equals(symbol.getName()))
